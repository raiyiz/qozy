...
CLASSIC_DARK = {
    **BASE,
    ...
    "surface": "#121820",
    "surface_alt": "#1A222C",
    "surface_hover": "#212A34",
    "input": "#121820",
    "border": "#32404F",
    "border_subtle": "#26323E",
    "text": "#F2F4F7",
    "muted": "#98A2B3",
    "placeholder": "#6F7A86",
    "primary": "#4F8CFF",
    "primary_hover": "#6A9CFF",
    "primary_pressed": "#3D73D8",
    "selection": "#263A62",
    "disabled": "#5E6874",
}
...
SOFT_DARK = {
    **BASE,
    ...
    "surface": "#1A2024",
    "surface_alt": "#22292E",
    "surface_hover": "#2A3238",
    "input": "#171D21",
    "border": "#39434A",
    "border_subtle": "#2C353B",
    "text": "#E8ECEF",
    "muted": "#A4ADB5",
    "placeholder": "#77828B",
    "primary": "#7E9FE9",
    "primary_hover": "#91AEF2",
    "primary_pressed": "#6787D0",
    "selection": "#2B3950",
    "disabled": "#68737C",
    "page_title_size": 27,
...
SOFT_LIGHT = {
    **BASE,
    ...
    "placeholder": "#A0A49D",
    "primary": "#6076B2",
    "primary_hover": "#7188C5",
    "primary_pressed": "#53669B",
    "selection": "#E1E7F3",
    "disabled": "#A2A69E",
    "page_title_size": 27,
    "section_title_size": 16,
